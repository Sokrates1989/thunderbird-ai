...
This source archive corresponds to AI Mail Assistant for Thunderbird 3.5.6.
...
license, and generates `install-defaults.json` for version 3.5.6.
...
The packaged manifest must report version `3.5.6`, extension ID
