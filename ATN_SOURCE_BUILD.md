...
This source archive corresponds to AI Mail Assistant for Thunderbird 3.3.4.
...
license, and generates `install-defaults.json` for version 3.3.4.
...
The packaged manifest must report version `3.3.4`, extension ID
