...
## Umfang von Release 3.5.2

Release 3.5.2 macht die eingeklappte Dashboard-Ansicht auf einen Blick
...
für die aktuelle Thunderbird-Sitzung.
...
1. `Thunderbird-AI-Setup-3.5.2-win-x64.exe` herunterladen und starten.
...
2. `Thunderbird-AI-Setup-3.5.2-macos.pkg` öffnen.
