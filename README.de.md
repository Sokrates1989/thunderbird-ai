...
## Umfang von Release 3.4.1

Release 3.4.1 verwendet für die API-Schlüssel-Hilfe ein vertrautes, eingekreistes
Informationssymbol. Die mit 3.4.0 eingeführte kurze deutsche oder englische
Einrichtungs-Checkliste bleibt für jeden Anbieter verfügbar und enthält
offizielle Zugangs- sowie sprachlich passende Dokumentationslinks.
...
1. `Thunderbird-AI-Setup-3.4.1-win-x64.exe` herunterladen und starten.
...
2. `Thunderbird-AI-Setup-3.4.1-macos.pkg` öffnen.
...
- `thunderbird-ai.xpi`
- `artifacts\Thunderbird-AI-Setup-3.4.1-win-x64.exe`
- `artifacts/Thunderbird-AI-Setup-3.4.1-macos.pkg`
