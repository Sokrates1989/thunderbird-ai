...
## Umfang von Release 3.3.5

In Release 3.3.5 wirkt **Alle** im Absenderfilter nur noch auf die aktuell
sichtbaren Suchergebnisse. Das Auswählen oder Abwählen gefilterter Treffer
verändert keine ausgeblendeten Absender mehr; außerdem stehen Beschriftungen
und Kontrollkästchen nun sauber auf einer Linie. Das sofortige Speichern der
Öffnungsart aus 3.3.4 bleibt enthalten.
...
1. `Thunderbird-AI-Setup-3.3.5-win-x64.exe` herunterladen und starten.
...
2. `Thunderbird-AI-Setup-3.3.5-macos.pkg` öffnen.
...
- `thunderbird-ai.xpi`
- `artifacts\Thunderbird-AI-Setup-3.3.5-win-x64.exe`
- `artifacts/Thunderbird-AI-Setup-3.3.5-macos.pkg`
