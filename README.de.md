...
## Umfang von Release 3.2.2

Release 3.2.2 erhöht das Ausgabelimit des API-Verbindungstests, damit
Reasoning-Modelle wie Hugging Face `openai/gpt-oss-120b` ihr Denken abschließen
und eine sichtbare Antwort liefern können. Der in 3.2.1 eingeführte kompakte
Dashboard-Name **AI Mail Assistant** und die sichere Markdown-Darstellung aus
3.2.0 bleiben unverändert.
...
1. `Thunderbird-AI-Setup-3.2.2-win-x64.exe` herunterladen und starten.
...
2. `Thunderbird-AI-Setup-3.2.2-macos.pkg` öffnen.
...
- `thunderbird-ai.xpi`
- `artifacts\Thunderbird-AI-Setup-3.2.2-win-x64.exe`
- `artifacts/Thunderbird-AI-Setup-3.2.2-macos.pkg`
