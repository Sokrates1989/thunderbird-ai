...
## Umfang von Release 3.4.0

Release 3.4.0 ergänzt für jeden auswählbaren AI-Anbieter eine kurze
API-Schlüssel-Anleitung direkt in den Einstellungen. Die deutsche oder englische
Checkliste enthält die offizielle Zugangsseite, anbieterspezifische Hinweise,
einen direkten Link zur vollständigen Anbieter-Anleitung und die Übersicht für
alle anderen unterstützten Anbieter. Die Absenderfilter-Korrektur aus 3.3.5
bleibt enthalten.
...
1. `Thunderbird-AI-Setup-3.4.0-win-x64.exe` herunterladen und starten.
...
2. `Thunderbird-AI-Setup-3.4.0-macos.pkg` öffnen.
...
- `thunderbird-ai.xpi`
- `artifacts\Thunderbird-AI-Setup-3.4.0-win-x64.exe`
- `artifacts/Thunderbird-AI-Setup-3.4.0-macos.pkg`
