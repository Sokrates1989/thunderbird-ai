...
## Umfang von Release 3.5.5

Release 3.5.5 ersetzt den UI-Aufbau über HTML-Zuweisungen durch ausdrückliche
DOM-Erzeugung. Übersetzte Beschriftungen, Anbieter-Metadaten, Diagnosen und
weitere dynamische Werte werden damit immer als reiner Text eingefügt. AI-Markdown
läuft weiterhin über den vorhandenen Renderer mit Positivliste. Ein Regressionstest
durchsucht die Erweiterung nach unsicheren HTML-Zuweisungen. Darstellung und
...
1. `Thunderbird-AI-Setup-3.5.5-win-x64.exe` herunterladen und starten.
...
2. `Thunderbird-AI-Setup-3.5.5-macos.pkg` öffnen.
