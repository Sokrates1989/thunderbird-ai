...
## Umfang von Release 3.3.4

Release 3.3.4 speichert die Öffnungsart für Dashboard und Einzelmail-Assistent
sofort beim Ändern der Auswahl. Die Einstellungen bleiben damit bei Installer-
Updates erhalten, ohne vom getrennten Speichern-Knopf abzuhängen. Schlägt das
Speichern fehl, wird sichtbar der letzte gespeicherte Wert wiederhergestellt.
Der Installertest schützt nun auch vorhandene Thunderbird-Profildaten. Die
übersichtlichere Einstellungsseite aus 3.3.3 bleibt enthalten.
...
1. `Thunderbird-AI-Setup-3.3.4-win-x64.exe` herunterladen und starten.
...
2. `Thunderbird-AI-Setup-3.3.4-macos.pkg` öffnen.
...
- `thunderbird-ai.xpi`
- `artifacts\Thunderbird-AI-Setup-3.3.4-win-x64.exe`
- `artifacts/Thunderbird-AI-Setup-3.3.4-macos.pkg`
