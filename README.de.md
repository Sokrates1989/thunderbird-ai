...
## Umfang von Release 3.5.3

Release 3.5.3 macht die eingeklappte Dashboard-Ansicht auf einen Blick
...
1. `Thunderbird-AI-Setup-3.5.3-win-x64.exe` herunterladen und starten.
...
2. `Thunderbird-AI-Setup-3.5.3-macos.pkg` öffnen.
