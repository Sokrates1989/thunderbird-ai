...
## Umfang von Release 3.4.2

Release 3.4.2 stellt den Dashboard-Start nach der Erweiterung der durchsuchbaren
Absenderauswahl wieder her. Eine explizite Absenderauswahl zeigt ihre Anzahl nun
ohne JavaScript-Fehler an, sodass ungelesene Nachrichten und die Absenderliste
normal geladen werden. Das mit 3.3.5 eingeführte gefilterte **Alle**-Verhalten
bleibt unverändert.
...
1. `Thunderbird-AI-Setup-3.4.2-win-x64.exe` herunterladen und starten.
...
2. `Thunderbird-AI-Setup-3.4.2-macos.pkg` öffnen.
...
- `thunderbird-ai.xpi`
- `artifacts\Thunderbird-AI-Setup-3.4.2-win-x64.exe`
- `artifacts/Thunderbird-AI-Setup-3.4.2-macos.pkg`
