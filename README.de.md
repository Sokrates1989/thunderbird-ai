...
## Umfang von Release 3.5.4

Release 3.5.4 bewahrt nachrichtenbezogene AI-Unterhaltungen beim Schließen und
erneuten Öffnen des Chats und ergänzt die ausdrücklich bestätigte Aktion
**Neuen Chat starten**. Sie löscht sichtbare Sprechblasen und API-Chatverlauf
gemeinsam und bleibt ohne Unterhaltung sowie während einer Antwort deaktiviert.
...
1. `Thunderbird-AI-Setup-3.5.4-win-x64.exe` herunterladen und starten.
...
2. `Thunderbird-AI-Setup-3.5.4-macos.pkg` öffnen.
...
- `thunderbird-ai.xpi`
- `artifacts\Thunderbird-AI-Setup-3.5.4-win-x64.exe`
- `artifacts/Thunderbird-AI-Setup-3.5.4-macos.pkg`
