...
`Thunderbird-AI-Setup-2.7.1-win-x64.exe`. Es installiert das Add-on nur für den
...
6. Eine E-Mail öffnen, die Zusammenfassung ausführen und den API-Test in den
   Einstellungen aufrufen. Im Einzelmail-Popup muss **Version 2.7.1** stehen und die Oberfläche muss deutsch sein.
