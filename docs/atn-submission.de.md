...
3.2.2. Bei Änderungen an Anbietern oder Datenkategorien muss es mit
...
1. `artifacts/thunderbird-ai-3.2.2.xpi` als Erweiterung hochladen.
2. `artifacts/thunderbird-ai-3.2.2-atn-source.zip` als Quellcode anhängen.
