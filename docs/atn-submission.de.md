...
3.4.2. Bei Änderungen an Anbietern oder Datenkategorien muss es mit
...
3. Im Thunderbird-Add-ons-Entwicklerbereich anmelden, eine neue **gelistete**
   ...
   `artifacts/thunderbird-ai-3.4.2.xpi` hochladen.
...
6. `artifacts/thunderbird-ai-3.4.2-atn-source.zip` und die Build-Anleitung aus
...
1. `artifacts/thunderbird-ai-3.4.2.xpi` als Erweiterung hochladen.
2. `artifacts/thunderbird-ai-3.4.2-atn-source.zip` als Quellcode anhängen.
