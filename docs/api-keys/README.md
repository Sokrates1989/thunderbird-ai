...
- [OpenAI API-Schlüssel erstellen](openai/README.md)
- [Claude-/Anthropic-API-Schlüssel erstellen](claude-anthropic/README.md)
- [Mistral-API-Schlüssel erstellen](mistral/README.md)
- [DeepSeek-API-Schlüssel erstellen](deepseek/README.md)
- [Individuellen AI-Endpunkt einrichten](custom-endpoint/README.md)
...
[Datenschutzerklärung des Projekts](../../README.md#datenschutz) beschriebenen
...
[AI-Anbieter-Testmatrix](../ai-provider-testing.md) dokumentiert.
