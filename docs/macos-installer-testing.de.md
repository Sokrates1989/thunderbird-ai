...
`Thunderbird-AI-Setup-3.2.2-macos.pkg`. Es verwendet ausschließlich die
...
2. `artifacts/Thunderbird-AI-Setup-3.2.2-macos.pkg` öffnen. Die GPL-Lizenzseite lesen und bestätigen. Im
...
5. In den Einstellungen OpenAI, Claude, Mistral, DeepSeek und den individuellen
   ...
   API-Test aufrufen. Im Einzelmail-Popup muss **Version 3.2.2** stehen.
