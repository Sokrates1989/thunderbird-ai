...
first public submission of AI Mail Assistant for Thunderbird 3.4.1. Keep the
...
3. Sign in to the Thunderbird Add-ons Developer Hub, start a new **listed**
   ...
   `artifacts/thunderbird-ai-3.4.1.xpi`.
...
6. Attach `artifacts/thunderbird-ai-3.4.1-atn-source.zip` and the build
...
1. Upload `artifacts/thunderbird-ai-3.4.1.xpi` as the listed extension.
2. Attach `artifacts/thunderbird-ai-3.4.1-atn-source.zip` as source code.
