...
first public submission of AI Mail Assistant for Thunderbird 3.2.2. Keep the
...
1. Upload `artifacts/thunderbird-ai-3.2.2.xpi` as the listed extension.
2. Attach `artifacts/thunderbird-ai-3.2.2-atn-source.zip` as source code.
