...
first public submission of AI Mail Assistant for Thunderbird 3.2.0. Keep the
...
1. Upload `artifacts/thunderbird-ai-3.2.0.xpi` as the listed extension.
2. Attach `artifacts/thunderbird-ai-3.2.0-atn-source.zip` as source code.
