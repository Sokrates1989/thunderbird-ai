...
Release 3.1.3 makes English the default documentation language and provides a
complete German counterpart for every maintained Markdown document. Root and
nested documentation links remain in the selected language. Provider behavior,
the DeepSeek response fix from 3.1.1, and the automatic native release pipeline
remain unchanged.

## Features

- Summaries based on the decoded MIME message body.
...
1. Download and run `Thunderbird-AI-Setup-3.1.3-win-x64.exe`.
...
2. Open `Thunderbird-AI-Setup-3.1.3-macos.pkg`.
