...
[How to get your API Key](docs/api-keys/README.md) gibt es eine eigene,
anklickbare Anleitung für OpenAI, Claude (Anthropic), Mistral, DeepSeek und
individuelle Endpunkte. Die
[AI-Anbieter-Testmatrix](docs/ai-provider-testing.md) zeigt zusätzlich, welche
Protokolle automatisiert und welche Anbieter bereits mit einer echten API
geprüft wurden.

## Umfang von Release 3.1.2

Release 3.1.2 ergänzt offizielle, getrennte API-Schlüssel-Anleitungen für
OpenAI, Claude (Anthropic), Mistral, DeepSeek und individuelle Endpunkte sowie
eine reproduzierbare manuelle Anbieter-Testmatrix. Der in 3.1.1 behobene Fehler
mit leeren DeepSeek-Antworten bleibt unverändert korrigiert. Die seit 3.1.0
vorhandene Anbieterauswahl und die automatische GitHub-Veröffentlichung mit
nativen Windows- und macOS-Builds bleiben unverändert.
...
1. `Thunderbird-AI-Setup-3.1.2-win-x64.exe` herunterladen und starten.
...
2. `Thunderbird-AI-Setup-3.1.2-macos.pkg` öffnen.
...
- `thunderbird-ai.xpi`
- `artifacts\Thunderbird-AI-Setup-3.1.2-win-x64.exe`
- `artifacts/Thunderbird-AI-Setup-3.1.2-macos.pkg`
