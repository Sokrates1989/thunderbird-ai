...
1. `Thunderbird-AI-Setup-2.16.0-win-x64.exe` herunterladen und starten.
...
2. `Thunderbird-AI-Setup-2.16.0-macos.pkg` öffnen.
...
- `thunderbird-ai.xpi`
- `artifacts\Thunderbird-AI-Setup-2.16.0-win-x64.exe`
- `artifacts/Thunderbird-AI-Setup-2.16.0-macos.pkg`
